...
public class BonziBuddyEntityModel extends SinglePartEntityModel<BonziBuddyEntity> implements BonziLikeModel {
...
//		return BonziLikeModel.getBonziModelData();
//	}
	...
	public void setAngles(BonziBuddyEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		updateAnimationStates(entity, this, ageInTicks, netHeadYaw, headPitch);
...
//		this.updateAnimation(entity.walkAnimState(), BonziBuddyAnimations.CLONE_WALK, ageInTicks);
//		this.updateAnimation(entity.attackAnimState(), BonziBuddyAnimations.CLONE_ATTACK, ageInTicks);
//		this.updateAnimation(entity.deathAnimState(), BonziBuddyAnimations.YIKES, ageInTicks);
	}
//	@Override
